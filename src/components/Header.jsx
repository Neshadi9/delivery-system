export function Header({ toggleLogin, toggleSignup }) {
  return (
    <nav className="sticky top-0 z-50 flex items-center justify-between px-40 py-4 bg-white shadow-sm">
      <div className="text-1xl font-bold text-slate-950">Dersual</div>
      <div className="flex items-center gap-6 text-sm">
        <ul className="flex items-center gap-6 font-medium text-slate-600">
          <li className="relative text-slate-900 after:absolute after:-bottom-2 after:left-0 after:h-0.5 after:w-full after:bg-orange-400">
            <a href="">Home</a>
          </li>
        ...
        <button 
            className="bg-orange-400 hover:bg-orange-300 text-white font-medium py-2 px-4 rounded-lg transition-all"
            onClick={(e) => {
                e.preventDefault()
                toggleSignup()
              }}
